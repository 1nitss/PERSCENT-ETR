...
<center><h2>UPDATE PRODUCT NO: {{ $product->id}} - {{ $product->perfume_name}}</h2></center>
               <div class="bg-white p-5 m-5 rounded">
                <form action="{{ route('product.update', $product->id) }}" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="form-group mb-3">
                        ...
                        <input type="text" class="form-control @error('perfume_name') is-invalid @enderror" name="perfume_name" value="{{ old('perfume_name', $product->perfume_name) }}" >
                        @error('perfume_name')
                    ...
                    <div class="form-group mb-3">
                        ...
                        <textarea class="form-control @error('perfume_desc') is-invalid @enderror" name="perfume_desc" >{{ old('perfume_desc', $product->perfume_desc) }}</textarea>
                        @error('perfume_desc')
                            <div class="invalid-feedback">{{ $message }}</div>
                        @enderror
                    </div>
                    <div class="form-group mb-3">
                        ...
                        <input type="number" step="0.01" class="form-control @error('perfume_price') is-invalid @enderror" name="perfume_price" value="{{ old('perfume_price', $product->perfume_price) }}" >
                        @error('perfume_price')
                            <div class="invalid-feedback">{{ $message }}</div>
                        @enderror
                    </div>
                    <div class="form-group mb-3">
                        ...
                        <input type="number" class="form-control @error('stocks') is-invalid @enderror" name="stocks" value="{{ old('stocks', $product->stocks) }}" >
                        @error('stocks')
                            <div class="invalid-feedback">{{ $message }}</div>
                        @enderror
                    </div>
