                ...
                <div class='col-md-3 col-sm-6'>
                    <div class='product-grid shadow-lg overflow-hidden' style="background-color: white">
                        <div class='product-image' style="border: 1px solid black">
                            ...
                            @csrf
                            <a href='{{ route('product.desc', ['product_name' => $perfumeProduct->perfume_name, 'product_desc' => $perfumeProduct->perfume_desc, 'product_image' => $perfumeProduct->perfume_image, 'product_price' => $perfumeProduct->perfume_price, 'product_id' => $perfumeProduct->id]) }}' class='image'>
